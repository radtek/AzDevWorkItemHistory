...
namespace WorkItemHistory
{
    public class ExitCode
    {
        ...
        public static ExitCode Unauthorized(VssUnauthorizedException exception, Uri azureUri) => new ExitCode(4, $"You need to re-login to {azureUri}. Your access token as either been revoked or expired.");
